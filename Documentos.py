...
while True:
    ...
    if doc == 0:
        ...
        cv2.putText(frame, 'ESTADO PLURINACIONAL DE BOLIVIA', (470, 750 - cuadro), cv2.FONT_HERSHEY_SIMPLEX, 0.71,(187, 170, 3), 2)
        print('Documento Boliviano')
        
    elif doc == 4:
        cv2.putText(frame, 'CEDULA DE INDENTIDAD', (470, 750 - cuadro), cv2.FONT_HERSHEY_SIMPLEX, 0.71,(187, 170, 3), 2)
        print('Documento Boliviano')
        
    elif doc == 5:
        cv2.putText(frame, 'CEDULA', (470, 750 - cuadro), cv2.FONT_HERSHEY_SIMPLEX, 0.71,(187, 170, 3), 2)
        print('Documento Boliviano')
